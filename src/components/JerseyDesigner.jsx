...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Restored height and moved to wearer's left (heart side) per latest request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [0.12, 0.22, 0.15], rot: Math.PI, scale: 0.12 });
    // Sponsor: Center
