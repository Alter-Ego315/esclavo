...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned lower and to wearer's left (viewer's right) per request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [0.12, 0.10, 0.15], rot: Math.PI, scale: 0.1 });
    // Sponsor: Center
