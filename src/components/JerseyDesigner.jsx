...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned lower and on the wearer's right side (viewer's left) per request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [-0.12, 0.07, 0.15], rot: Math.PI, scale: 0.1 });
    // Sponsor: Center
