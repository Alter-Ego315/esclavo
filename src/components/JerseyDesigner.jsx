...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned much lower and further left per user request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [-0.18, 0.05, 0.15], rot: Math.PI, scale: 0.12 });
    // Sponsor: Center
