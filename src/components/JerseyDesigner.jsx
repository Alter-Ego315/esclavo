...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned further left (viewer's perspective) per user request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [-0.15, 0.24, 0.14], rot: Math.PI, scale: 0.12 });
    // Sponsor: Center
