...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned lower and slightly less to wearer's left per latest request
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [0.08, 0.07, 0.15], rot: Math.PI, scale: 0.1 });
    // Sponsor: Center
