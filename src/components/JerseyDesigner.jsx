...
const JerseyDesigner = () => {
    ...
    // Crest (Escudo): Positioned much lower and on the wearer's left (heart side) per clarification
    const [teamLogoPos, setTeamLogoPos] = useState({ pos: [0.18, 0.02, 0.15], rot: Math.PI, scale: 0.12 });
    // Sponsor: Center
